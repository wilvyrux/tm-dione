<?php
if(!class_exists('TM_Switch_Param'))
{
	class TM_Switch_Param
	{
		function __construct()
		{
			if ( class_exists( 'WpbakeryShortcodeParams' ) )
			{
				WpbakeryShortcodeParams::addField('switch' , array($this, 'checkbox_param'));
			}
		}
...
if(class_exists('TM_Switch_Param'))
{
	$TM_Switch_Param = new TM_Switch_Param();
}
